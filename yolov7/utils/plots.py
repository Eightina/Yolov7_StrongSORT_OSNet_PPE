...
def plot_skeleton_kpts(im, kpts, steps, orig_shape=None):
    ...
    skeleton = [[16, 14], [14, 12], [17, 15], [15, 13], [12, 13], [6, 12],
                ...
                [1, 2], [1, 3], [2, 4], [3, 5], [4, 6], [5, 7]] # point: 1 ~ 17
    ...
    for kid in range(num_kpts): # 0 ~ 16: 17
        r, g, b = pose_kpt_color[kid] 
        x_coord, y_coord = kpts[steps * kid], kpts[steps * kid + 1] # [0, 3, 6...], [1, 4, 7,...]
        if not (x_coord % 640 == 0 or y_coord % 640 == 0):
            if steps == 3:
                conf = kpts[steps * kid + 2] # [2, 5, 8,...]
                if conf < 0.5:
                    continue
